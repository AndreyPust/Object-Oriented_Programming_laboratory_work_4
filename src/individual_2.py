...
class TrainManager:
    ...
    def add_train(self, departure_point, number_train, time_departure, destination):
        """
...
def main():
    ...
    logging.basicConfig(
        ...
        level=logging.INFO,  # Уровень логгирования: INFO (записывает и предупреждения, и ошибки)
        format="%(asctime)s [%(levelname)s] %(message)s",  # Формат сообщения в логе
    )
